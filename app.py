...
try:
    ...
    modulo_map = {
        ...
        "admin": [
            "Cadastro", "Leads de Eventos", "Follow-up", "Agendamentos",
        ...
        "supervisao_n1": [
            "Cadastro", "Leads de Eventos", "Follow-up", "Agendamentos", "Roteiro de Vendas"
        ],
        "supervisao_n2": [
            "Cadastro", "Leads de Eventos", "Follow-up", "Agendamentos", "Roteiro de Vendas",
...
try:
    ...
    # 🆕 NOVO MÓDULO: LEADS DE EVENTOS
    elif modulo == "Leads de Eventos":
        from modules.leads_eventos import render_registro_lead, render_lista_leads
