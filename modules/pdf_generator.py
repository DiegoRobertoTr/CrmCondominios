...
def extrair_valor_do_plano(plano_nome):
    ...
    # Busca padrão: número com vírgula (formato brasileiro)
...
Cidade: {{ cidade_empresa }} - {{ estado_empresa }}
CEP: {{ cep_empresa }}
...
Instalação: R$ {{ valor_instalacao or '0,00' }}
...
**DECLARAÇÃO DE CONCORDÂNCIA DO CONTRATANTE**
...
def gerar_pdf_termo_adesao(dados_cliente):
    ...
    try:
        ...
        dados.setdefault("optou_fidelidade", True)  # Padrão: Sim
